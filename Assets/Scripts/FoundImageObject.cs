...
public class FoundImageObject
{
    ...
    public FoundImageObject(JSONObject cat)
    {
        ...
        GetHighestCategory();
        var soundManager = GameObject.FindWithTag("TextManager");
        System.Diagnostics.Debug.WriteLine(soundManager.name.ToString());
        TextToSpeech tsm= soundManager.GetComponent<TextToSpeech>();
